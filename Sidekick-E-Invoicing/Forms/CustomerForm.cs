...
public class CustomerForm : Form
{
    ...
    public CustomerForm()
    {
        ...
        var header = new Label
        {
            ...
            BackColor = ColorTranslator.FromHtml("#1b6656"),  // Sidekick Primary header
        ...
        btnUpdate = MakeButton("✏️ Update", "#1b6656");
        ...
        dgvCustomers.ColumnHeadersDefaultCellStyle.BackColor = ColorTranslator.FromHtml("#1b6656");
