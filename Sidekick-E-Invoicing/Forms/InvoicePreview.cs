...
public class InvoicePreviewForm : Form
{
    ...
    private void InitializeLayout()
    {
        ...
        /*btnPrint = new Button
        {
            ...
            Width = 180,
            Height = 38,
            BackColor = Color.FromArgb(27, 102, 86),
        ...
        Panel bannerPanel = new Panel
        {
            Dock = DockStyle.Top,
            Height = 32,
            BackColor = Color.FromArgb(27, 102, 86), // Navy color
        ...
        Panel bannerAccent = new Panel
        {
            Dock = DockStyle.Top,
            Height = 2,
            BackColor = Color.FromArgb(123, 176, 107), // Gold/Amber color
        ...
        Panel metadataDivider = new Panel
        {
            Dock = DockStyle.Top,
            Height = 2,
            BackColor = Color.FromArgb(27, 102, 86), // Navy
        ...
        var sellerBox = new GroupBox
        {
            ...
            ForeColor = Color.FromArgb(27, 102, 86),
            AutoSize = true,
            AutoSizeMode = AutoSizeMode.GrowAndShrink,
    ...
    private void GenerateVectorPdf(string filePath)
    {
        ...
        try
        {
            ...
            pdfDoc.Info.Author = "Sidekick E-Invoicing System";
            ...
            Action drawHeader = () =>
            {
                ...
                if (!hasLogo)
                {
                    ...
                    string sName = header["sellerBusinessName"]?.ToString() ?? "SIDEKICK BUSINESS";
