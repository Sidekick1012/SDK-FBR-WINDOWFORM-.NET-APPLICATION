...
public class ReportingForm : Form
{
    ...
    public ReportingForm()
    {
        ...
        btnGenerate  = MakeBtn("🔍 Generate", "#1D2068");
        ...
        dgvReport.ColumnHeadersDefaultCellStyle.BackColor = ColorTranslator.FromHtml("#1D2068");
...
LIMIT 50";
    ...
    private void ExportExcelReport()
    {
        ...
        using (var dlg = new SaveFileDialog())
        {
            ...
            dlg.FileName = $"HCR_Report_{cmbReportType.Text.Replace(" ", "_")}_{DateTime.Now:yyyyMMdd_HHmm}.xlsx";
        ...
        using (var package = new ExcelPackage())
        {
            ...
            sheet.Cells[1, 1].Value = $"📊 HCR E-Invoicing Report — {cmbReportType.Text}";
            sheet.Cells[1, 1, 1, 10].Merge = true;
            sheet.Cells[1, 1].Style.Font.Name = "Segoe UI";
            sheet.Cells[1, 1].Style.Font.Size = 16;
            sheet.Cells[1, 1].Style.Font.Bold = true;
            sheet.Cells[1, 1].Style.Font.Color.SetColor(ColorTranslator.FromHtml("#1D2068"));
            ...
            sheet.Cells[3, 1].Style.Font.Color.SetColor(ColorTranslator.FromHtml("#1D2068"));
            ...
            if (!isInvoiceList)
            {
                ...
                foreach (DataGridViewColumn col in dgvReport.Columns)
                {
                    ...
                    cell.Style.Fill.BackgroundColor.SetColor(ColorTranslator.FromHtml("#1D2068"));
            ...
            else
            {
                ...
                foreach (DataGridViewRow row in dgvReport.Rows)
                {
                    ...
                    invHeaderCell.Style.Fill.BackgroundColor.SetColor(ColorTranslator.FromHtml("#1D2068"));
                    ...
                    sellerHeader.Style.Font.Color.SetColor(ColorTranslator.FromHtml("#1D2068"));
                    ...
                    customerHeader.Style.Font.Color.SetColor(ColorTranslator.FromHtml("#1D2068"));
                    ...
                    Action<string, object, bool> drawTotalRow = (lbl, val, isGrand) =>
                    {
                        ...
                        if (isGrand) lblCell.Style.Font.Color.SetColor(ColorTranslator.FromHtml("#1D2068"));
